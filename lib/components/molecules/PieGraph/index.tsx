...
export interface BDSPieGraphProps {
	data: dataItem[];
	legends?: boolean;
	width?: number;
	height?: number;
...
type PieGraphComponent = ComponentType<BDSPieGraphProps>;
 ...
 * 파이 그래프 컴포넌트
 *
 * @param {dataItem[]} data - 파이 그래프 데이터
 * @param {boolean} [legends] - 범례 여부
 * @param {number} [width] - 그래프 너비
 * @param {number} [height] - 그래프 높이
 */
export const PieGraph: PieGraphComponent = ({ data, legends, width = 400, height = 400 }) => {
