...
`,ht=typeof re!="string"?ge`
        animation: ${re} 1.4s linear infinite;
      `:null,mt=typeof ne!="string"?ge`
        animation: ${ne} 1.4s ease-in-out infinite;
      `:null,gt=t=>{const{classes:e,variant:r,color:i,disableShrink:n}=t,s={root:["root",r,`color${J(i)}`],svg:["svg"],circle:["circle",`circle${J(r)}`,n&&"circleDisableShrink"]};return be(s,dt,e)},bt=A("span",{name:"MuiCircularProgress",slot:"Root",overridesResolver:(t,e)=>{const{ownerState:r}=t;return[e.root,e[r.variant],e[`color${J(r.color)}`]]}})(ye(({theme:t})=>({display:"inline-block",variants:[{props:{variant:"determinate"},style:{transition:t.transitions.create("transform")}},{props:{variant:"indeterminate"},style:ht||{animation:`${re} 1.4s linear infinite`}},...Object.entries(t.palette).filter(We()).map(([e])=>({props:{color:e},style:{color:(t.vars||t).palette[e].main}}))]}))),yt=A("svg",{name:"MuiCircularProgress",slot:"Svg",overridesResolver:(t,e)=>e.svg})({display:"block"}),Mt=A("circle",{name:"MuiCircularProgress",slot:"Circle",overridesResolver:(t,e)=>{const{ownerState:r}=t;return[e.circle,e[`circle${J(r.variant)}`],r.disableShrink&&e.circleDisableShrink]}})(ye(({theme:t})=>({stroke:"currentColor",variants:[{props:{variant:"determinate"},style:{transition:t.transitions.create("stroke-dashoffset")}},{props:{variant:"indeterminate"},style:{strokeDasharray:"80px, 200px",strokeDashoffset:0}},{props:({ownerState:e})=>e.variant==="indeterminate"&&!e.disableShrink,style:mt||{animation:`${ne} 1.4s ease-in-out infinite`}}]}))),It=l.forwardRef(function(e,r){const i=oe({props:e,name:"MuiCircularProgress"}),{className:n,color:s="primary",disableShrink:o=!1,size:c=40,style:u,thickness:p=3.6,value:d=0,variant:h="indeterminate",...b}=i,y={...i,color:s,disableShrink:o,size:c,thickness:p,value:d,variant:h},m=gt(y),x={},M={},S={};if(h==="determinate"){const B=2*Math.PI*((I-p)/2);x.strokeDasharray=B.toFixed(3),S["aria-valuenow"]=Math.round(d),x.strokeDashoffset=`${((100-d)/100*B).toFixed(3)}px`,M.transform="rotate(-90deg)"}return k.jsx(bt,{className:E(m.root,n),style:{width:c,height:c,...M,...u},ownerState:y,ref:r,role:"progressbar",...S,...b,children:k.jsx(yt,{className:m.svg,ownerState:y,viewBox:`${I/2} ${I/2} ${I} ${I}`,children:k.jsx(Mt,{className:m.circle,style:x,ownerState:y,cx:I,cy:I,r:(I-p)/2,fill:"none",strokeWidth:p})})})});export{Vt as B,It as C,Z as a,wt as u};
//# sourceMappingURL=CircularProgress-DrwmfEn_.js.map
